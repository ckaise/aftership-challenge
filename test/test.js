 ...
 * To run the test
 * > mocha --timeout 5000
 * timeout depends on network traffic
 */
...
describe('Test: .is', function() {
    ...
    describe('Track @ usps(\'9405903699300184125060\')', function() {
        ...
        it('Expect return true', function() {
            ...
            return result.should.eventually.deep.equal(usps);
        });
    });
    ...
    describe('Track @ hkpost(\'CP889331175HK\')', function() {
        ...
        it('Expect return true', function() {
            ...
            return result.should.eventually.deep.equal(hkpost);
        });
    });
    ...
    describe('Track @ dpduk(\'15502370264989N\')', function() {
        ...
        it('Expect return true', function() {
            ...
            return result.should.eventually.deep.equal(dpduk);
        });
    });
});
